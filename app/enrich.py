...
CATEGORY_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("Télécom / Internet", ("BOUYGUES", "SFR", "ORANGE", "SOSH", "FREE", "RED BY", "BYTEL", "B&YOU")),
    ...
    ("Streaming / Loisirs", ("NETFLIX", "SPOTIFY", "DEEZER", "DISNEY", "PRIME VIDEO", "AMAZON PRIME",
                             "CANAL", "YOUTUBE", "APPLE.COM", "ITUNES", "PLAYSTATION", "XBOX",
                             "STEAM", "MOLOTOV", "OCS", "AUDIBLE")),
    ...
    ("Alimentation", ("CARREFOUR", "AUCHAN", "LECLERC", "LIDL", "INTERMARCHE", "MONOPRIX", "CASINO",
                      "FRANPRIX", "PICARD", "BIOCOOP", "GRAND FRAIS", "NATURALIA", "ALDI", "COURSES U")),
